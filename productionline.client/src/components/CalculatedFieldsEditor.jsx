...
const EnhancedCalculatedFieldsEditor = ({
    ...
    const FormulaHelpSystem = ({ visible, onClose }) => {
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg p-6 max-w-2xl max-h-96 overflow-y-auto">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-bold">🧮 Formula Help</h3>
                        <button onClick={onClose}><X className="w-5 h-5" /></button>
                    </div>

                    <div className="space-y-4 text-sm">
                        <div>
                            <h4 className="font-medium mb-2">📝 Formula Syntax Rules:</h4>
                            <ul className="list-disc list-inside space-y-1 ml-4">
                                <li>Always wrap field names in quotes: <code>"Sales Amount"</code></li>
                                <li>Separate parameters with commas: <code>ADD("Field1", "Field2")</code></li>
                                <li>Numbers don't need quotes: <code>EFFICIENCY("Output", "Input", 8)</code></li>
                                <li>Function names are case-sensitive: <code>SUM</code> not <code>sum</code></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-1 ml-4">
                                <li>Use the quick templates for common calculations</li>
                                <li>Click on field names to insert them automatically</li>
                                <li>Check for red/yellow validation messages below formulas</li>
                                <li>Test with a few sample rows before finalizing</li>
                            </ul>
                        </div>

                        <div className="bg-blue-50 p-3 rounded">
                            <h4 className="font-medium text-blue-800 mb-2">🎯 Most Common Formulas:</h4>
                            <div className="space-y-2 text-blue-700">
                                <div><code>SUM("Column Name")</code> - Add all values</div>
                                <div><code>ADD("Col1", "Col2")</code> - Add columns per row</div>
                                <div><code>MULTIPLY("Qty", "Price")</code> - Multiply per row</div>
                                <div><code>AVG("Scores")</code> - Average of all values</div>
                            </div>
                        </div>
                    </div>
                </div>
